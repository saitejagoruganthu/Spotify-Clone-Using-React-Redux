  ...
  return (
    <>
      <div className="md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#171717]">
        <img src={myLogo} alt="logo" className="w-full h-24 object-contain"/>
        <NavLinks />
      </div>
      ...
      <div className={`absolute top-0 h-screen w-2/3 bg-gradient-to-tl from-[#404040] to-[#171717] backdrop-blur-lg z-10 p-6 md:hidden smooth-transition ${mobileMenuOpen ? 'left-0' : '-left-full'}`}>
        <img src={myLogo} alt="logo" className="w-full h-24 object-contain"/>
